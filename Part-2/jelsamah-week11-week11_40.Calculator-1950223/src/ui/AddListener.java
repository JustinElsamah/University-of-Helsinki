...
public class AddListener implements ActionListener{
    ...
    public AddListener(Calculator calculator, JTextField untouchableText, JTextField inputText, JButton resetButton){
    ...
    public void actionPerformed(ActionEvent e) {
        try{
        this.calculator.addToCalculator(this.inputText.getText());
